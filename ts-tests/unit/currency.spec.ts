...
import { formatCurrency, unMaskCurrency, defaultConfig } from '../../ts/utils/currency'

describe('Testing Currency Formatter', () => {
  it('should mask currency value', () => {
    const numbers = 123456
    const currency = formatCurrency(numbers, defaultConfig)
  ...
  it('should mask numbers with four decimals', () => {
    ...
    const currency = formatCurrency(numbers, {
      thousands: ',',
      decimal: '.',
      precision: 4
    })
