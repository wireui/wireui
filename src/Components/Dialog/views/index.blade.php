<div @class([
    ...
    $alignClasses,
]) x-data="wireui_dialog({ id: '{{ $dialog }}' })" x-show="show"
    ...
    <div @class([
        ...
        <div class="relative p-4 bg-white shadow-md dark:bg-secondary-800 rounded-xl"
            ...
            <div x-show="dialog && dialog.closeButton" class="absolute right-2 top-2">
                <button
                    class="{{ $dialog }}-button-close cursor-pointer focus:outline-none focus:outline-hidden p-1 focus:ring-2 focus:ring-secondary-200 rounded-full text-secondary-300"
