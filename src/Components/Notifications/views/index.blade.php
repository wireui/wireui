    ...
    <div class="flex flex-col-reverse w-full max-w-sm gap-y-2 pointer-events-auto">
        <template x-for="notification in notifications" :key="`notification-${notification.id}`">
            <div class="relative w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg pointer-events-auto ring-1 ring-black/5 dark:bg-secondary-800 dark:border dark:border-secondary-700"
                ...
                <div
                    :class="{
                        'ps-4': Boolean(notification.dense),
                    ...
                    <div
                        ...
                        <div class="w-0 flex-1 pt-0.5"
                            :class="{
                                'ms-3': Boolean(notification.icon || notification.img)
                            }">
                            ...
                            <template
                                ...
                                <div class="flex mt-3 gap-x-3">
                                    <button
                                        class="cursor-pointer text-sm font-medium rounded-md focus:outline-none focus:outline-hidden"
                                        :class="{
                                            ...
                                            'px-3 py-2 border shadow-xs': Boolean($wireui.dataGet(notification,
                                                'accept.solid')),
                                        }"
                                    ...
                                    <button
                                        ...
                                        :class="{
                                            ...
                                            'px-3 py-2 border border-secondary-300 shadow-xs': Boolean($wireui.dataGet(
                        ...
                        <div class="flex ms-4 shrink-0">
                            <!-- accept button -->
                            <button
                                class="cursor-pointer me-4 text-sm font-medium rounded-md shrink-0 focus:outline-none focus:outline-hidden"
                                :class="{
                            ...
                            <!-- close button -->
                            <button
                                class="cursor-pointer inline-flex rounded-md text-secondary-400 hover:text-secondary-500 focus:outline-none focus:outline-hidden"
                                x-show="notification.closeButton" x-on:click="closeNotification(notification)">
                                <span class="sr-only">Close</span>
                                <x-dynamic-component :component="WireUi::component('icon')" class="w-5 h-5" name="x-mark" />
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <template x-if="notification.rightButtons">
                    <div class="flex flex-col border-s border-secondary-200 dark:border-secondary-700">
                        <template x-if="notification.accept">
                            <div class="flex flex-1 h-0"
                                ...
                                <button
                                    class="cursor-pointer flex items-center justify-center w-full px-4 py-3 text-sm font-medium rounded-none rounded-se-lg focus:outline-none focus:outline-hidden"
                                    :class="{
                                        ...
                                        'rounded-ee-lg': !Boolean(notification.reject),
                                    }"
                        ...
                        <template x-if="notification.reject">
                            <div class="flex flex-1 h-0">
                                <button
                                    class="cursor-pointer flex items-center justify-center w-full px-4 py-3 text-sm font-medium rounded-none rounded-ee-lg focus:outline-none focus:outline-hidden"
                                    :class="{
                                        ...
                                        'rounded-se-lg': !Boolean(notification.accept),
                                    }"
