...
class Toggle extends Checkbox
{
    ...
    public function backgroundClasses(bool $hasError): string
    {
        ...
        return Arr::toCssClasses([
            ...
            'bg-secondary-200 peer-checked:bg-primary-600 peer-focus:ring-primary-600'     => !$hasError,
            'group-focus:ring-primary-600 dark:group-focus:ring-secondary-600'             => !$hasError,
            'dark:peer-focus:ring-secondary-600 dark:peer-focus:ring-offset-secondary-800' => !$hasError,
            'dark:bg-secondary-600 dark:peer-checked:bg-secondary-700'                     => !$hasError,
            'bg-negative-600 peer-focus:ring-negative-600 dark:bg-negative-700'            => $hasError,
            'group-focus:ring-negative-600 dark:group-focus:ring-negative-700'             => $hasError,
            'dark:peer-focus:ring-negative-700 dark:peer-focus:ring-offset-secondary-800'  => $hasError,
        ]);
    }
