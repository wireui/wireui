...
class Badge extends BaseBadge
{
    ...
    {
        return [
            self::DEFAULT => 'border text-slate-500 dark:border-slate-500 dark:text-slate-400',
            'primary'     => 'text-primary-500 border border-primary-500',
            'secondary'   => 'text-secondary-600 border border-secondary-600 dark:border-secondary-400 dark:text-secondary-400',
            ...
            'dark'        => 'text-slate-600 border border-slate-600 dark:border-slate-400 dark:text-slate-400',
            'white'       => 'border border-white text-white dark:text-slate-200 dark:border-slate-400',
            'black'       => 'border border-black text-black dark:text-slate-200 dark:border-slate-400',
            ...
            'lime'        => 'ring-lime-500 text-lime-500 border border-lime-500',
            'green'       => 'ring-green-500 text-green-500 border border-green-500',
            'emerald'     => 'text-emerald-500 border border-emerald-500',
            'teal'        => 'ring-teal-500 text-teal-500 border border-teal-500',
            'cyan'        => 'ring-cyan-500 text-cyan-500 border border-cyan-500',
            'sky'         => 'ring-sky-500 text-sky-500 border border-sky-500',
            'blue'        => 'ring-blue-500 text-blue-500 border border-blue-500',
            'indigo'      => 'ring-indigo-500 text-indigo-500 border border-indigo-500',
            'violet'      => 'ring-violet-500 text-violet-500 border border-violet-500',
            'purple'      => 'ring-purple-500 text-purple-500 border border-purple-500',
            'fuchsia'     => 'ring-fuchsia-500 text-fuchsia-500 border border-fuchsia-500',
            'pink'        => 'ring-pink-500 text-pink-500 border border-pink-500',
            'rose'        => 'ring-rose-500 text-rose-500 border border-rose-500',
        ];
    }
    ...
    public function defaultColors(): array
    {
        return [
            ...
            'white'       => 'bg-white border text-slate-500 dark:text-slate-200 dark:border-slate-700 dark:bg-slate-700',
            'black'       => 'bg-black text-slate-100 dark:border-slate-700 dark:bg-slate-700',
