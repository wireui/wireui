...
exports["default"] = function (options) {
  ...
  return _objectSpread(_objectSpread(_objectSpread({}, alpine_1.baseComponent), positioning_1.positioning), {}, {
    ...
    parseFormat: (_options$parseFormat = options.parseFormat) !== null && _options$parseFormat !== void 0 ? _options$parseFormat : 'YYYY-MM-DDTHH:mm:ss.SSSZ',
    ...
    mustSyncDate: function mustSyncDate() {
      ...
      var inputDate = (_this$input3 = this.input) === null || _this$input3 === void 0 ? void 0 : _this$input3.format('YYYY-MM', this.localTimezone);
    ...
    emitInput: function emitInput() {
      ...
      this.model = (_this$input4 = this.input) === null || _this$input4 === void 0 ? void 0 : _this$input4.format(this.parseFormat, this.timezone);
    },
    syncInput: function syncInput() {
      var _this$input5, _this$input6, _this$input7;

      if (this.model && ((_this$input5 = this.input) === null || _this$input5 === void 0 ? void 0 : _this$input5.format(this.parseFormat)) !== this.model) {
        this.input = (0, date_1.date)(this.model, this.timezone, this.parseFormat);
      }

      if (!this.model || (_this$input6 = this.input) !== null && _this$input6 !== void 0 && _this$input6.isInvalid()) {
        this.input = (0, date_1.date)(new Date(), this.userTimezone).setTimezone(this.timezone);
      }

      this.modelTime = (_this$input7 = this.input) === null || _this$input7 === void 0 ? void 0 : _this$input7.getTime(this.userTimezone);
    },
    selectDate: function selectDate(date) {
      ...
      if (!this.withoutTimezone) {
        ...
        (_this$input8 = this.input) === null || _this$input8 === void 0 ? void 0 : _this$input8.setTimezone(this.userTimezone);
      }

      (_this$input9 = this.input) === null || _this$input9 === void 0 ? void 0 : _this$input9.setYear(date.year).setMonth(date.month).setDay(date.day);

      if (!this.withoutTimezone) {
        var _this$input10;

        (_this$input10 = this.input) === null || _this$input10 === void 0 ? void 0 : _this$input10.setTimezone(this.timezone);
      }
    ...
    selectTime: function selectTime(time) {
      ...
      if (!this.withoutTimezone) {
        ...
        (_this$input11 = this.input) === null || _this$input11 === void 0 ? void 0 : _this$input11.setTimezone(this.userTimezone);
      }

      (_this$input12 = this.input) === null || _this$input12 === void 0 ? void 0 : _this$input12.setTime(time.value);

      if (!this.withoutTimezone) {
        var _this$input13;

        (_this$input13 = this.input) === null || _this$input13 === void 0 ? void 0 : _this$input13.setTimezone(this.timezone);
      }
    ...
    getDisplayValue: function getDisplayValue() {
      ...
      if (this.displayFormat) {
        ...
        return (_this$input14 = this.input) === null || _this$input14 === void 0 ? void 0 : _this$input14.format(this.displayFormat, timezone);
      }

      return (_this$input15 = this.input) === null || _this$input15 === void 0 ? void 0 : _this$input15.getNativeDate().toLocaleString(navigator.language, this.localeDateConfig);
    },
    getSearchPlaceholder: function getSearchPlaceholder() {
      if (this.config.is12H) {
        var _this$input$format, _this$input16;

        return (_this$input$format = (_this$input16 = this.input) === null || _this$input16 === void 0 ? void 0 : _this$input16.format('h:mm a', this.userTimezone)) !== null && _this$input$format !== void 0 ? _this$input$format : '12:00 AM';
      }
...
var makeTimes = function makeTimes(_ref) {
  ...
  var currentTime = (Number(minHours) + Number(minMinutes)) * 60;
  var maxTime = (Number(maxHours) + Number(maxMinutes)) * 60;
  var times = [];
  ...
  while (currentTime < maxTime) {
    ...
    if (time12H) {
      ...
      time.label = "".concat(Number(displayHour % 12), ":").concat(minutes, " ").concat(timePeriods[Math.floor(Number(hours) / 12)]);
    }
...
var slider_1 = __importDefault(__webpack_require__(/*! ./inputs/slider/slider */ "./ts/components/inputs/slider/slider.ts"));

var sliderRange_1 = __importDefault(__webpack_require__(/*! ./inputs/slider/sliderRange */ "./ts/components/inputs/slider/sliderRange.ts"));

var sliderButton_1 = __importDefault(__webpack_require__(/*! ./inputs/slider/sliderButton */ "./ts/components/inputs/slider/sliderButton.ts"));
...
document.addEventListener('alpine:init', function () {
  ...
  window.Alpine.data('wireui_inputs_slider', slider_1["default"]);
  window.Alpine.data('wireui_inputs_slider_range', sliderRange_1["default"]);
  window.Alpine.data('wireui_inputs_slider_button', sliderButton_1["default"]);
...
/***/ "./ts/components/inputs/slider/slider.ts":
/*!***********************************************!*\
  !*** ./ts/components/inputs/slider/slider.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = function (params) {
  return {
    ...
    get barSize() {
      ...
      return "".concat(((_this$value = this.value) !== null && _this$value !== void 0 ? _this$value : this.min - this.min) / (this.max - this.min) * 100, "%");
    },
    ...
    inputChange: function inputChange() {
      ...
      this.value = Number(this.$refs.input.value);
      window.Alpine.evaluate(this.$refs['button'].firstElementChild, "setValue = ".concat(this.value));
    },
    emitChange: function emitChange(input, value) {
      if (this.disabled) return;
    ...
    setPosition: function setPosition(newPosition) {
      window.Alpine.evaluate(this.$refs['button'].firstElementChild, "setPosition('".concat(newPosition, "')"));
    },
...
/***/ "./ts/components/inputs/slider/sliderButton.ts":
/*!*****************************************************!*\
  !*** ./ts/components/inputs/slider/sliderButton.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var tippy_js_1 = __importDefault(__webpack_require__(/*! tippy.js */ "./node_modules/tippy.js/dist/tippy.esm.js"));
  ...
  return {
    ...
    init: function init() {
      ...
      if (!this.hideTooltipParent) {
        var button = this.input.replace("input", "button");
        var tooltip = this.$refs[button].firstElementChild.firstElementChild;
        this.instance = (0, tippy_js_1["default"])(tooltip, {
    ...
    emitChange: function emitChange() {
      window.Alpine.evaluate(this.$refs.sliderComponent, "emitChange('".concat(this.input, "', '").concat(this.value, "')"));
    },
    setDataValueOrder: function setDataValueOrder() {
      if (this.range) {
    ...
    showTooltip: function showTooltip() {
      ...
      this.instance.setContent("".concat(this.value));
      this.instance.show();
    },
    ...
    buttonEnter: function buttonEnter() {
      this.hovering = true;
      this.showTooltip();
    },
    buttonLeave: function buttonLeave() {
      this.hovering = false;
      this.hideTooltip();
    },
    buttonDown: function buttonDown(event) {
      if (this.disabled) return;
...
/***/ "./ts/components/inputs/slider/sliderRange.ts":
/*!****************************************************!*\
  !*** ./ts/components/inputs/slider/sliderRange.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = function (params) {
  return {
    ...
    inputChange: function inputChange(event) {
      if (this.disabled) return;
      var input = event.target.getAttribute('x-ref');
    ...
    setDataValueOrder: function setDataValueOrder() {
      ...
      window.Alpine.evaluate(this.$refs['button1'].firstElementChild, "setValue = ".concat(this.firstValue));
      window.Alpine.evaluate(this.$refs['button2'].firstElementChild, "setValue = ".concat(this.secondValue));
    },
    ...
    setPosition: function setPosition(newPosition) {
      var button;
      var targetValue = this.min + newPosition * (this.max - this.min) / 100;
...
exports.positioning = _objectSpread(_objectSpread({}, alpine_1.baseComponent), {}, {
  ...
  initPositioningSystem: function initPositioningSystem() {
    ...
    var callback = this.syncPopoverPosition.bind(this);
    this.$watch('popover', function () {
      if (window.innerWidth >= 640) {
        _this.toggleEventListener(callback);
      }
    });
  },
  toggleEventListener: function toggleEventListener(callback) {
    var _this2 = this;

    if (this.popover) {
      window.addEventListener('scroll', callback);
      this.$nextTick(function () {
        return _this2.syncPopoverPosition();
      });
    } else {
  ...
  syncPopoverPosition: function syncPopoverPosition() {
    ...
    var _this$$refs$popover = this.$refs.popover,
        clientHeight = _this$$refs$popover.clientHeight,
        clientWidth = _this$$refs$popover.clientWidth;
    var topHeightSpace = window.innerHeight - rect.bottom;
    var leftWidthSpace = rect.right;
...
/******/ 	__webpack_require__.O(undefined, ["external","wireui"], () => (__webpack_require__("./ts/index.ts")))
/******/ 	__webpack_require__.O(undefined, ["external","wireui"], () => (__webpack_require__("./resources/css/wireui.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["external","wireui"], () => (__webpack_require__("./resources/css/external.css")))
