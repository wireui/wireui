...
class TestCase extends \Orchestra\Testbench\Dusk\TestCase
{
    ...
    protected function defineEnvironment($app)
    {
        ...
        // Override layout/page namespaces to resolve package browser-test views.
        $app['view']->addNamespace('layouts', __DIR__.'/views/components/layouts');
        $app['view']->addNamespace('pages', __DIR__.'/views/components/pages');

        // Force full-page Livewire components to use the browser test layout.
        $app['config']->set('livewire.layout', 'components.layouts.app');
    ...
    {
        return base_path('tests/Browser'.($path ? '/'.$path : ''));
    }
